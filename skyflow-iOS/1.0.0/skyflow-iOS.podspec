#
#  Be sure to run `pod spec lint skyflow-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "akhil-skyflow"
  # spec.authors            = { "akhil-skyflow" => "akhil.mangala@skyflow.com" }
  # spec.social_media_url   = "https://twitter.com/akhil-skyflow"
